...
# Node.js is present, then runs `npx @trusty-squire/mcp@latest connect`, passing
# through any arguments. If you already have Node, running
# `npx @trusty-squire/mcp@latest connect` directly does exactly the same thing.
...
exec npx -y @trusty-squire/mcp@latest connect "$@"
