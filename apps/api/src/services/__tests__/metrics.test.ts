  ...
  it("emits HELP/TYPE/value for every gauge plus labelled build_info", () => {
    ...
    expect(out).toBe(
      [
        ...
        "# HELP squire_llm_events_total Total LLM proxy usage events recorded.",
        "# TYPE squire_llm_events_total gauge",
        "squire_llm_events_total 1234",
...
function stubPrisma(): {
  ...
  const prisma = {
    ...
    lLMUsageEvent: { count: vi.fn(() => Promise.resolve(1234)) },
